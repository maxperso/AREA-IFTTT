...
class ChuckNorrisPage extends StatefulWidget {
  ...
  const ChuckNorrisPage({super.key, required this.onConfigured});
...
class _ChuckNorrisPageState extends State<ChuckNorrisPage> {
  ...
  Future<void> _sendChuckNorrisRequest() async {
    String? token = await Storage.getToken();
    if (token != null) {
      var url = Uri.parse('${Config.apiBaseUrl}/area/chucknorris');
              ...
              child: Column(
                children: <Widget>[
                  const Align(
                    ...
                    child: Text(
                      'Chuck Norris Widget', // Add the text you want to display
                      style: TextStyle(
                  ...
                  ElevatedButton(
                    onPressed: _sendChuckNorrisRequest,
